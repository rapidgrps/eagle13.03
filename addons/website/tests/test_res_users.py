...
from eagle.tests.common import TransactionCase, new_test_user
from eagle.exceptions import ValidationError
from eagle.service.model import check
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_same_website_message(self):
        ...
        with self.assertRaises(ValidationError), mute_logger('eagle.sql_db'):
