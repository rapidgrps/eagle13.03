eagle.define('iap.CrashManager', function (require) {
"use strict";
...
CrashManager.include({
    ...
    _getButtonMessage: function (isTrial){
        ...
        return isTrial && isEnterprise ? _t('Start a Trial at Eagle') : _t('Buy credits');
    },
    /**
     * @override
     */
    rpc_error: function (error) {
        var self = this;
        if (error.data.name === "eagle.addons.iap.models.iap.InsufficientCreditError") {
            ...
            ajax.jsonRpc('/web/dataset/call_kw', 'call', {
                ...
                var content = $(QWeb.render('iap.redirect_to_eagle_credit', {
                        data: error_data,
                    }));
                if (error_data.body) {
