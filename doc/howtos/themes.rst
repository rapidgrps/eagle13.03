...
``category`` defines your module category (always “Theme”) and, after a slash, the subcategory. You can use one subcategory from the Eagle Apps categories list. (https://www.eagle-erp.com/apps/themes)
