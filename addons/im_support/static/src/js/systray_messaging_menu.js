eagle.define('im_support.systray.MessagingMenu', function (require) {
"use strict";
...
MessagingMenu.include({
    ...
    init: function () {
        ...
        this.supportChannel = {
            ...
            name: _t("Eagle Live Support"),
            title: _t("Eagle Live Support"),
            imageSRC: '/mail/static/src/img/eagle_o.png',
        };
    },
    /**
