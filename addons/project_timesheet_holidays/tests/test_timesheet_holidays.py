...
from eagle import fields, SUPERUSER_ID

from eagle.tests import common, new_test_user
from eagle.addons.hr_timesheet.tests.test_timesheet import TestCommonTimesheet
