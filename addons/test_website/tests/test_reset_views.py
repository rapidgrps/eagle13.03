...
class TestWebsiteResetViews(eagle.tests.HttpCase):
    ...
    @mute_logger('eagle.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('eagle.addons.http_routing.models.ir_http', 'eagle.addons.website.models.ir_ui_view')
