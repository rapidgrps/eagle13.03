eagle.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in eagle.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" eagle domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in eagle.
 */
...
/**
 * Let users choose a document, including uploading a new document in eagle.
 */
