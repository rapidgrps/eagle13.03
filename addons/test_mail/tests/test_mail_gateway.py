...
from eagle.addons.test_mail.data import test_mail_data
from eagle.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from eagle.addons.test_mail.models.test_mail_models import MailTestGateway
from eagle.addons.test_mail.tests.common import BaseFunctionalTest, MockEmails
from eagle.addons.test_mail.tests.common import mail_new_test_user
from eagle.tests import tagged
from eagle.tools import email_split_and_format, mute_logger, pycompat, formataddr
...
class TestMailgateway(BaseFunctionalTest, MockEmails):
    ...
    @mute_logger('eagle.addons.mail.models.mail_thread', 'eagle.models')
    ...
    @mute_logger('eagle.addons.mail.models.mail_thread')
    ...
    @mute_logger('eagle.addons.mail.models.mail_thread', 'eagle.models.unlink', 'eagle.addons.mail.models.mail_mail')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by eagle should update thread accordingly """
    ...
    @mute_logger('eagle.addons.mail.models.mail_thread', 'eagle.models', 'eagle.addons.mail.models.mail_mail')
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # Eagle 10 update: compat mode has been removed and should not work anymore
