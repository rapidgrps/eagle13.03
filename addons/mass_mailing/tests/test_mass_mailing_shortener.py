...
Email: <a id="url4" href="mailto:test@eagle-erp.com">test@eagle-erp.com</h1>
            """,
            "schedule_date": False,
            "state": "draft",
            "keep_archives": True,
        ...
        self.assertEqual(after_url4, "mailto:test@eagle-erp.com", 'mailto: has been converted')
        ...
        self.assertEqual(short2.url, "https://www.eagle-erp.com", 'URL mismatch')
        ...
        self.assertEqual(_after_url4, "mailto:test@eagle-erp.com", 'mailto: has been converted')
        ...
        self.assertEqual(_short2.url, "https://www.eagle-erp.com", 'URL mismatch')
