...
from eagle.exceptions import AccessError, except_orm, ValidationError, UserError
...
class TestChannelAccessRights(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('eagle.addons.base.models.ir_model', 'eagle.models')
    ...
    @mute_logger('eagle.addons.base.models.ir_model', 'eagle.models', 'eagle.models.unlink')
...
class TestChannelModeration(common.Moderation):
    ...
    @mute_logger('eagle.addons.mail.models.mail_channel', 'eagle.models.unlink')
