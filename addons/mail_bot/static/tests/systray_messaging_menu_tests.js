eagle.define('mail_bot.systray.MessagingMenuTests', function (require) {
"use strict";
...
QUnit.test('messaging menu widget: rendering with EagleBot has a request', async function (assert) {
    assert.expect(5);
    ...
    assert.strictEqual(messagingMenu.$('.o_preview_name').text().trim(),
        'EagleBot has a request',
        "preview should display that EagleBot has a request");
...
QUnit.test('messaging menu widget: rendering without EagleBot has a request (denied)', async function (assert) {
    assert.expect(3);
...
QUnit.test('messaging menu widget: rendering without EagleBot has a request (accepted)', async function (assert) {
    assert.expect(3);
