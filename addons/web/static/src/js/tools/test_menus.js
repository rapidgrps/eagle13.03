(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = eagle.__DEBUG__.services['web.AbstractController'];
        var Discuss = eagle.__DEBUG__.services['mail.Discuss'];
        var WebClient = eagle.__DEBUG__.services["web.WebClient"];
    ...
    function _clickEverywhere(menu_id){
        ...
        testedApps = [];
        testedMenus = [];
        var isEnterprise = eagle.session_info.server_version_info[5] === 'e';
        // finding applications menus
        var $listOfAppMenuItems;
        if (isEnterprise) {
            console.log("Eagle flavor: Enterprise");
            ...
            console.log("Eagle flavor: Community");
            if (menu_id !== undefined) {
