eagle.define('web.mixins', function (require) {
"use strict";
...
function EagleEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
EagleEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

EagleEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new EagleEvent(this, name, info);
