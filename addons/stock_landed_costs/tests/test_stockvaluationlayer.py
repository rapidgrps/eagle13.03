...
from eagle.tests import Form, tagged
from eagle.addons.stock_account.tests.test_stockvaluationlayer import TestStockValuationCommon
from eagle.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
