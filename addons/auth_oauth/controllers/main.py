...
from eagle import api, http, SUPERUSER_ID, _
from eagle.exceptions import AccessDenied
from eagle.http import request
from eagle import registry as registry_get

from eagle.addons.auth_signup.controllers.main import AuthSignupHome as Home
from eagle.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
