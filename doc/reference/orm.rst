...
.. autoclass:: eagle.models.BaseModel()
    ...
    .. seealso:: :class:`eagle.models.AbstractModel`

    .. autoattribute:: _transient

    .. seealso:: :class:`eagle.models.TransientModel`
...
.. autoclass:: eagle.models.AbstractModel()

Model
-----

.. autoclass:: eagle.models.Model()

TransientModel
--------------

.. autoclass:: eagle.models.TransientModel()
...
into a compatible type: :func:`~eagle.fields.Date.to_date` will convert to a `datetime.date`
object while :func:`~eagle.fields.Datetime.to_datetime` will convert to a `datetime.datetime`.
...
:class:`~eagle.fields.Date` and :class:`~eagle.fields.Datetime`.
These helpers are also available by importing `eagle.tools.date_utils`.

.. note:: Timezones

    Datetime fields are stored as `timestamp without timezone` columns in the database and are stored
    in the UTC timezone. This is by design, as it makes the Eagle database independent from the timezone
...
.. attribute:: id
    ...
    Identifier :class:`field <eagle.fields.Field>`
...
.. attribute:: create_date
    ...
    :class:`~eagle.fields.Datetime`

.. attribute:: create_uid

    :class:`~eagle.fields.Many2one`
...
.. attribute:: name
  ...
  default value for :attr:`~eagle.models.BaseModel._rec_name`, used to
  display records in context where a representative "naming" is
  necessary.

  :class:`~eagle.fields.Char`
...
..   in list views.
..
..   :class:`~eagle.fields.Integer`

.. attribute:: state

  lifecycle stages of the object, used by the ``states`` attribute on
  :class:`fields <eagle.fields.Field>`.

  :class:`~eagle.fields.Selection`
...
.. attribute:: company_id
  ...
  Main field name used for Eagle multi-company behavior.

  Used by `:meth:~eagle.models._check_company` to check multi company consistency.
  Defines whether a record is shared between companies (no value) or only
  accessible by the users of a given company.

  :class:`~eagle.fields.Many2one`
  :type: :class:`~eagle.addons.base.models.res_company`
...
.. note::
    ...
    records, use :meth:`~eagle.models.BaseModel.mapped`::
...
Accessing a relational field (:class:`~eagle.fields.Many2one`,
:class:`~eagle.fields.One2many`, :class:`~eagle.fields.Many2many`)
...
The :class:`~eagle.api.Environment` stores various contextual data used by
...
using :attr:`~eagle.models.Model.env` and gives access to:

* the current user (:attr:`~eagle.api.Environment.user`)
* the cursor (:attr:`~eagle.api.Environment.cr`)
* the superuser flag (:attr:`~eagle.api.Environment.su`)
* or the context (:attr:`~eagle.api.Environment.context`)
...
The :attr:`~eagle.api.Environment.cr` attribute on environments is the
...
Because models use the same cursor and the :class:`~eagle.api.Environment`
...
.. note::
    ...
    :meth:`~eagle.models.Model.invalidate_cache` method.

.. automethod:: Model.invalidate_cache

.. warning::
    Executing raw SQL bypasses the ORM, and by consequent, Eagle security rules.
...
* ``field_name`` (``str``)
    ...
    a :class:`~eagle.fields.Many2one` using dot-notation e.g. ``'street'``
...
* ``operator`` (``str``)
    ...
    ``child_of``
        ...
        :attr:`~eagle.models.Model._parent_name`).
    ``parent_of``
...
.. attribute:: env
    ...
    :type: :class:`~eagle.api.Environment`
...
.. literalinclude:: ../../eagle/addons/test_documentation_examples/inheritance.py
    :language: python
    :lines: 6-

and using them:

.. literalinclude:: ../../eagle/addons/test_documentation_examples/tests/test_inheritance.py
    :language: python
    :lines: 10,11,14,19
...
When using :attr:`~eagle.models.Model._inherit` but leaving out
:attr:`~eagle.models.Model._name`, the new model replaces the existing one,
...
.. literalinclude:: ../../eagle/addons/test_documentation_examples/extension.py
    :language: python
    :lines: 6-

.. literalinclude:: ../../eagle/addons/test_documentation_examples/tests/test_extension.py
    :language: python
    :lines: 10,15
...
at runtime) but less power: using the :attr:`~eagle.models.Model._inherits`
...
:class:`~eagle.fields.Reference` fields automatically set up on the parent
model.
...
.. literalinclude:: ../../eagle/addons/test_documentation_examples/delegation.py
    :language: python
    :lines: 5-

.. literalinclude:: ../../eagle/addons/test_documentation_examples/tests/test_delegation.py
    :language: python
    :lines: 11-14,23,28
