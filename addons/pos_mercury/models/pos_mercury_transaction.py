...
from eagle import models, api, service
from eagle.tools.translate import _
from eagle.exceptions import UserError
from eagle.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "Eagle " + service.common.exp_version()['server_version']
