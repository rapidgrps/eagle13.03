...
import eagle
from eagle import api, http, models, tools, SUPERUSER_ID
from eagle.exceptions import AccessDenied, AccessError
from eagle.http import request, content_disposition
from eagle.tools import consteq, pycompat
from eagle.tools.mimetypes import guess_mimetype
from eagle.modules.module import get_resource_path, get_module_path

from eagle.http import ALLOWED_DEBUG_MODES
from eagle.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(eagle.conf.server_wide_modules)
            if tools.config['test_enable'] and eagle.modules.module.current_test:
                installed.add(eagle.modules.module.current_test)
