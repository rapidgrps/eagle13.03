...
from eagle import models, api, _, fields
from eagle.osv import expression
from eagle.release import version
from eagle.tools import DEFAULT_SERVER_DATE_FORMAT as DF, safe_eval
from eagle.tools.misc import formatLang, format_date as eagle_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                activities.append({
                    ...
                    'date': eagle_format_date(self.env, activity.get('date_deadline'))
                })
