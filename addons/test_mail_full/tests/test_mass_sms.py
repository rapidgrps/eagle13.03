...
from eagle.addons.phone_validation.tools import phone_validation
from eagle.addons.mass_mailing_sms.tests import common as mass_mailing_sms_common
from eagle.addons.test_mail.tests import common as test_mail_common
