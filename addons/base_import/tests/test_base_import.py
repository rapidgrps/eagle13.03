...
from eagle.tests.common import TransactionCase, can_import
from eagle.modules.module import get_module_resource
from eagle.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('eagle.addons.base_import.models.base_import')
