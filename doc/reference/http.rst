...
:class:`~eagle.models.Model`, but can't use the same mechanism as the
...
Controllers are created by :ref:`inheriting <python:tut-inheritance>` from :class:`~eagle.http.Controller`.
Routes are defined through methods decorated with :func:`~eagle.http.route`::
...
* decorating with :func:`~eagle.http.route` is necessary to keep the method
...
The request object is automatically set on :data:`eagle.http.request` at
the start of the request

.. autoclass:: eagle.http.WebRequest
    :members:
    :member-order: bysource
.. autoclass:: eagle.http.HttpRequest
    :members:
.. autoclass:: eagle.http.JsonRequest
    :members:

Response
--------

.. autoclass:: eagle.http.Response
    :members:
    :member-order: bysource
