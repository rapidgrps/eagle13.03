...
.. note:: An html version of all js docstrings in Eagle is available at:
      :ref:`JS API <api/js>`
...
- *web.assets_common*: this bundle contains most assets which are common to the
  ...
  lower level building blocks for the eagle framework.  Note that it contains the
  *boot.js* file, which defines the eagle module system.
...
.. note ::
    ...
    eagle web client.  This means that the files are transferred through the network
...
.. code-block:: javascript
    ...
    // in file a.js
    eagle.define('module.A', function (require) {
        "use strict";
    ...
    // in file b.js
    eagle.define('module.B', function (require) {
        "use strict";
...
.. code-block:: javascript
    ...
    eagle.define('module.Something', ['module.A', 'module.B'], function (require) {
        "use strict";
...
The *eagle.define* method is given three arguments:

- *moduleName*: the name of the javascript module.  It should be a unique string.
  The convention is to have the name of the eagle addon followed by a specific
...
.. code-block:: javascript
      ...
      eagle.define('module.Something', ['web.ajax'], function (require) {
        "use strict";
...
.. code-block:: javascript
    ...
    eagle.define('module.Something', function (require) {
        "use strict";
...
The eagle Class system does not support multiple inheritance, but for those cases
...
handled by eagle and correspond to italic and bold, respectively).  Note that the
