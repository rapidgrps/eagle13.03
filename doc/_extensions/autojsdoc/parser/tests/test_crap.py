# -*- coding: utf-8 -*-
"""
Test various crap patterns found in Eagle code to ensure they don't blow up
the parser thingie
"""
...
def test_prototype():
    ...
    eagle.define('mod2', function (require) {
