...
from eagle.addons.test_mass_mailing.tests.common import MassMailingCase
from eagle.addons.base.models.ir_config_parameter import IrConfigParameter
from eagle.tests.common import TransactionCase, users
