...
from eagle import api, fields, models, SUPERUSER_ID, _
from eagle.osv import expression
from eagle.tools import DEFAULT_SERVER_DATETIME_FORMAT
from eagle.tools.float_utils import float_compare, float_is_zero, float_round
from eagle.exceptions import UserError
from eagle.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, Eagle will automatically pre-fill the detailed "
