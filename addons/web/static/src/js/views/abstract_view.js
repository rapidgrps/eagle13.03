eagle.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. Eagle JS views are the
 ...
 * the word 'view' has historical significance in Eagle code, so we replaced the
