...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('eagle.addons.hw_posbox_upgrade', "views")
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def upgrade(self):
        commit = subprocess.check_output(["git", "--work-tree=/home/pi/eagle/", "--git-dir=/home/pi/eagle/.git", "log", "-1"]).decode('utf-8').replace("\n", "<br/>")
