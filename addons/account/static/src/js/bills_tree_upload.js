eagle.define('account.upload.bill.mixin', function (require) {
"use strict";
...
eagle.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
eagle.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');
