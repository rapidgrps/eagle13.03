...
from eagle.exceptions import AccessError, ValidationError, UserError
from eagle.tools import mute_logger, test_reports

from eagle.addons.hr_holidays.tests.common import TestHrHolidaysBase
