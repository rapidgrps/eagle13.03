...
from eagle.addons.payment_ingenico.controllers.main import OgoneController
from eagle.addons.payment_ingenico.data import ogone
from eagle.http import request
from eagle.tools import DEFAULT_SERVER_DATE_FORMAT, ustr
from eagle.tools.float_utils import float_compare, float_repr, float_round
...
class PaymentAcquirerOgone(models.Model):
    ...
    def _ogone_generate_shasign(self, inout, values):
        ...
        :param string inout: 'in' (eagle contacting ogone) or 'out' (ogone
