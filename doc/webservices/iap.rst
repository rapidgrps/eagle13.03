...
.. note:: The credits went from integer to float value starting **October 2018**.
    ...
    * for a postage service: 1 credit = 1 post stamp.
    ...
    that the clients can buy on https://iap.eagle-erp.com (see :ref:`Packs <iap-packages>`).
...
.. todo:: for the actual IAP will the "portal" page be on eagle-erp.com or iap.eagle-erp.com?
...
.. danger::
    ...
    IAP endpoint, https://iap.eagle-erp.com. While developing and testing your
...
.. class:: ServiceName
    ...
    String identifying your service on https://iap.eagle-erp.com (production) as well
