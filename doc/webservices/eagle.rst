...
.. only:: html
    ...
    .. rst-class:: setupcode hidden
        ...
        .. code-block:: python3
            ...
            info = xmlrpc.client.ServerProxy('https://demo.eagle-erp.com/start').start()
        ...
        .. code-block:: ruby
            ...
            info = XMLRPC::Client.new2('https://demo.eagle-erp.com/start').call('start')
            url, db, username, password = \
                info['host'], info['database'], info['user'], info['password']
        ...
        .. code-block:: php
            ...
            $info = ripcord::client('https://demo.eagle-erp.com/start')->start();
        ...
        .. code-block:: java
            ...
            start_config.setServerURL(new URL("https://demo.eagle-erp.com/start"));
...
.. warning::
    ...
    *https://mycompany.eagle-erp.com*), the *database name* is the name of the
...
To make exploration simpler, you can also ask https://demo.eagle-erp.com for a test
database:
