function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('eagle-google-map'), {
        zoom: 1,
    ...
    if (eagle_partner_data){ /* eagle_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < eagle_partner_data.counter; i++) {
            set_marker(eagle_partner_data.partners[i]);
        }
