...
from eagle.addons.payment.models.payment_acquirer import _partner_split_name
...
class AuthorizeAPI():
    ...
    def create_customer_profile(self, partner, opaqueData):
        ...
        a corresponding payment profile to it. Note that a single partner in the Eagle
