...
def safe_eval(expr, globals_dict=None, locals_dict=None, mode="eval", nocopy=False, locals_builtins=False):
    ...
    except eagle.exceptions.except_orm:
        raise
    except eagle.exceptions.Warning:
        raise
    except eagle.exceptions.RedirectWarning:
        raise
    except eagle.exceptions.AccessDenied:
        raise
    except eagle.exceptions.AccessError:
        raise
    except werkzeug.exceptions.HTTPException:
        raise
    except eagle.http.AuthenticationError:
        raise
