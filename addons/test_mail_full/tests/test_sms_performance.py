...
from eagle.addons.test_mail.tests.test_performance import BaseMailPerformance
from eagle.tests.common import users, warmup
...
class TestSMSPerformance(BaseMailPerformance, sms_common.MockSMS):
    ...
    @mute_logger('eagle.addons.sms.models.sms_sms')
    @users('employee')
    @warmup
