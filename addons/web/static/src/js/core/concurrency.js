eagle.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Eagle.
 *
 * The basic concurrency primitives in Eagle JS are the callback, and the
...
return {
    ...
    /**
     * A (Eagle) mutex is a primitive for serializing computations.  This is
