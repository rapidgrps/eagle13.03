...
from eagle.http import Controller, dispatch_rpc, request, route
from eagle.service import wsgi_server
from eagle.fields import Date, Datetime


class EagleMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = EagleMarshaller
