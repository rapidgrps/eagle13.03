...
from eagle.modules.module import get_module_root, MANIFEST_NAMES
from eagle.service.db import _create_empty_database, DatabaseExists
...
class Start(Command):
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            eagle.tools.config['init']['base'] = True
