...
from eagle.tools.float_utils import float_round as round, float_compare
from eagle.tools import DEFAULT_SERVER_DATETIME_FORMAT
from eagle.exceptions import UserError, ValidationError
from eagle import api, fields, models, _, tools
from eagle.tests.common import Form
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('eagle', 'Eagle'),('euro', 'European')], default='eagle', help="You can choose different models for each type of reference. The default one is the Eagle reference.")
    ...
    inbound_payment_method_ids = fields.Many2many('account.payment.method', 'account_journal_inbound_payment_method_rel', 'journal_id', 'inbound_payment_method',
        ...
        help="Manual: Get paid by cash, check or any other method outside of Eagle.\n"\
    ...
    outbound_payment_method_ids = fields.Many2many('account.payment.method', 'account_journal_outbound_payment_method_rel', 'journal_id', 'outbound_payment_method',
        ...
        help="Manual:Pay bill by cash or any other method outside of Eagle.\n"\
