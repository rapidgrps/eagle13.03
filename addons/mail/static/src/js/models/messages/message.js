eagle.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isEaglebotAuthor()) {
            return '/mail/static/src/img/eaglebot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or Eaglebot messages
     * (note: Eaglebot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isEaglebotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If Eaglebot is the author (default author for transient messages),
     * returns 'Eaglebot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is EagleBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isEaglebotAuthor: function () {
        return this._serverAuthorID &&
            this._serverAuthorID[0] === this.call('mail_service', 'getEaglebotID')[0];
    },
    /**
