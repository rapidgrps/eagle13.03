...
def test_single():
     ...
     */
    eagle.define('supermodule', function (req) {
        var other = req('other');
    });
    """)
...
def test_multiple():
    ...
    eagle.define('module1', function (req) {
        return 1;
    });
    eagle.define('module2', function (req) {
        return req('dep2');
    });
    eagle.define('module3', function (req) {
        var r = req('dep3');
        return r;
    });
    """)
...
def test_func():
    [mod] = parse("""
    eagle.define('module', function (d) {
        /**
...
def test_export_instance():
    [mod] = parse("""
    eagle.define('module', function (require) {
...
def test_bounce():
    [m2, m1] = parse("""
    eagle.define('m2', function (require) {
        var Item = require('m1');
        return {
            Item: Item
        };
    });
    eagle.define('m1', function (require) {
        var Class = require('Class');
...
def test_reassign():
    [m] = parse("""
    eagle.define('m', function (require) {
        var Class = require('Class');
        /** local class */
