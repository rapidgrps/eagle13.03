...
from eagle.modules import load_information_from_description_file
from eagle.tools import convert_file, exception_to_unicode
from eagle.tools.osutil import tempdir
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempdir() as module_dir:
                import eagle.modules.module as module
                try:
                    eagle.addons.__path__.append(module_dir)
                    ...
                    eagle.addons.__path__.remove(module_dir)
