...
from eagle.addons.payment_alipay.controllers.main import AlipayController
            ...
            if currency_id:
                ...
                if currency and currency.name != 'CNY':
                    ...
                    raise ValidationError(_("""
                        ...
                        configuration to a Cross-border account on the Alipay payment acquirer in Eagle.
                    """))
        return True
