...
from eagle.exceptions import RedirectWarning, UserError, ValidationError
from eagle.tools import float_is_zero, float_compare, safe_eval, date_utils, email_split, email_escape_char, email_re
from eagle.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_eagle_invoice(self):
        """ This computes the reference based on the Eagle format.
    ...
    def _get_invoice_reference_eagle_partner(self):
        """ This computes the reference based on the Eagle format.
