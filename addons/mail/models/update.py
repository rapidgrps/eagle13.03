...
from eagle import api, release, SUPERUSER_ID
from eagle.exceptions import UserError
from eagle.models import AbstractModel
from eagle.tools.translate import _
from eagle.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Eagle's publisher warranty server to check the
