...
.. autoclass:: eagle.tests.common.SingleTransactionCase
    :members: browse_ref, ref

.. autoclass:: eagle.tests.common.SavepointCase

.. autoclass:: eagle.tests.common.HttpCase
    :members: browse_ref, ref, url_open, phantom_js

.. autofunction:: eagle.tests.common.tagged
...
.. autofunction:: eagle.tests.common.at_install

.. autofunction:: eagle.tests.common.post_install

The most common situation is to use
:class:`~eagle.tests.common.TransactionCase` and test a property of a model
in each method::
...
.. autoclass:: eagle.tests.common.Form
    :members:

.. autoclass:: eagle.tests.common.M2MProxy
    :members: add, remove, clear

.. autoclass:: eagle.tests.common.O2MProxy
...
:class:`~eagle.tests.common.TransactionCase`,
:class:`~eagle.tests.common.SavepointCase` or
:class:`~eagle.tests.common.HttpCase`) are automatically tagged with
``standard``, ``at_install`` and their source module's name by default.

Invocation
^^^^^^^^^^

:option:`--test-tags <eagle-bin --test-tags>` can be used to select/filter tests
...
.. danger:: :func:`~eagle.tests.common.tagged` is a class decorator, it has no
...
.. code-block:: python
    ...
    from eagle.tests import TransactionCase, tagged
...
.. code-block:: console
    ...
    $ eagle-bin --test-enable --test-tags nice
...
:option:`--test-tags <eagle-bin --test-tags>`: on the command-line, values
are *additive* (you're selecting all tests with *any* of the specified tags)

.. code-block:: console

    $ eagle-bin --test-enable --test-tags nice,standard
...
.. code-block:: console
    ...
    $ eagle-bin --test-enable --test-tags 'standard,-slow'

When you write a test that does not inherit from the
:class:`~eagle.tests.common.BaseCase`, this test will not have the default tags,
...
- *module_name*: Eagle tests classes extending
  ...
  .. code-block:: console
      ...
      $ eagle-bin --test-enable --test-tags stock_account
...
.. important::
    ...
    modules have to be selected with the :option:`-u <eagle-bin -u>` or
    :option:`-i <eagle-bin -i>` switches.  For simplicity, those switches are
...
.. code-block:: console
    ...
    $ eagle-bin --test-enable --test-tags sale

Run the tests from the sale module but not the ones tagged as slow:

.. code-block:: console

    $ eagle-bin --test-enable --test-tags 'sale,-slow'

Run only the tests from stock or tagged as slow:

.. code-block:: console

    $ eagle-bin --test-enable --test-tags '-standard, slow, stock'
...
guarantee that some basic functionality still works. Since Eagle has a non trivial
...
The Eagle framework uses the QUnit_ library testing framework as a test runner.
...
The main way to run the test suite is to have a running Eagle server, then
...
With the way Eagle is designed, any addon can modify the behaviour of other parts
...
1. create a new file *my_addon/static/tests/utils_tests.js*. This file contains the basic code to
   add a QUnit module *my_addon > utils*.
    ...
    .. code-block:: javascript
        ...
        eagle.define('my_addon.utils_tests', function (require) {
        "use strict";
...
Without help, it is quite difficult to test some parts of Eagle. In particular,
...
- Mock test functions: these functions help setting up a test environment. The
  most important use case is mocking the answers given by the Eagle server. These
...
- `qunit assertions`_: QUnit can be extended with specialized assertions. For
  Eagle, we frequently test some DOM properties. This is why we made some
...
.. code-block:: console
  ...
  '/tmp/eagle_tests/{db_name}/screenshots/'

Two new command line arguments were added since Eagle 13.0 to control this behavior:
:option:`--screenshots <eagle-bin --screenshots>` and :option:`--screencasts <eagle-bin --screencasts>`


.. _qunit: https://qunitjs.com/
.. _qunit_config.js: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/static/tests/helpers/qunit_config.js#L49
.. _web.js_tests_assets: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/views/webclient_templates.xml#L427
.. _web.qunit_suite: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/views/webclient_templates.xml#L509
.. _controller: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/controllers/main.py#L637
.. _test_js.py: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/tests/test_js.py#L13
.. _test_utils.js: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/static/tests/helpers/test_utils.js
.. _mock server: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/static/tests/helpers/mock_server.js
.. _qunit assertions: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/static/tests/helpers/qunit_asserts.js
.. _createView: https://github.com/eagle/eagle/blob/51ee0c3cb59810449a60dae0b086b49b1ed6f946/addons/web/static/tests/helpers/test_utils_create.js#L267
