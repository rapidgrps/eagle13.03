eagle.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that Eagle actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute Eagle actions, given as an ID in
     ...
     * @private
     * @param {EagleEvent} ev
     * @param {EagleEvent} ev.data.controllerID
     */
