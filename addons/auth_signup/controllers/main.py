...
from eagle.addons.auth_signup.models.res_users import SignupError
from eagle.addons.web.controllers.main import ensure_db, Home
from eagle.addons.base_setup.controllers.main import BaseSetup
