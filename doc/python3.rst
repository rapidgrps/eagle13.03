...
* fixing dependencies
* using a ``collections.OrderedDict`` or ``eagle.tools.misc.OrderedSet`` instead
...
:func:`eagle.tools.pycompat.csv_reader` and
:func:`eagle.tools.pycompat.csv_writer`: they take a *UTF-8 byte stream* and
