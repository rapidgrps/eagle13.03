...
from eagle.addons.portal.controllers.portal import CustomerPortal, pager as portal_pager
from eagle.tools import groupby as groupbyelem

from eagle.osv.expression import OR
