...
from eagle import exceptions, tests
from eagle.addons.test_mail.tests.common import BaseFunctionalTest
from eagle.addons.test_mail.models.test_mail_models import MailTestActivity
