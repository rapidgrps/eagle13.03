...
"""The Eagle API module defines Eagle Environments and method decorators.
...
from eagle.tools import frozendict, classproperty, lazy_property, StackMap
from eagle.exceptions import CacheMiss
...
def constrains(*args):
    ...
    Should raise :exc:`~eagle.exceptions.ValidationError` if the
    validation failed.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/eagle/eagle/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~eagle.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~eagle.addons.base.models.res_users`"""
...
from eagle.exceptions import UserError, AccessError, MissingError
