...
from eagle.tools import OrderedSet
from eagle.addons.http_routing.models.ir_http import slug, _guess_mimetype
from eagle.addons.web.controllers.main import Binary
from eagle.addons.portal.controllers.portal import pager as portal_pager
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': eagle.service.common.exp_version()
        }
