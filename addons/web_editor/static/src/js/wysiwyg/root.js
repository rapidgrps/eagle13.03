eagle.define('web_editor.wysiwyg.root', function (require) {
'use strict';
...
var WysiwygRoot = Widget.extend({
    ...
    willStart: function () {
        ...
        return this._super().then(function () {
            if (!assetsLoaded) {
                var Wysiwyg = eagle.__DEBUG__.services['web_editor.wysiwyg'];
    ...
    _getWysiwygContructor: function () {
        return eagle.__DEBUG__.services['web_editor.wysiwyg'];
    }
});
...
eagle.define('web_editor.wysiwyg.default_options', function (require) {
'use strict';
